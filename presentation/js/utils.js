...
queryAll('#links').forEach(function(el) {
el.addEventListener('click', _t.onCommandClick.bind(_t), false);
});
  };
...
case 'bkgrd':
        this._update("background-slide"); break;
case 'work':
        this._update("how_it_works1"); break;
case 'example':
        this._update("example-slide"); break;
case 'math':
        this._update("markov-slide"); break;
case 'demo':
        this._update("demosetup-slide"); break;
case 'quest':
        this._update("questions-slide"); break;
case 'demourl':
        this._update("http://playground.uncc.edu/~ctalbot1/iGDD/Talbot-Christine-GradPresentation-2011/demo/index.html"); break;
      case 'resources':
        break;
      case 'notes':
        this.showNotes(); break;
